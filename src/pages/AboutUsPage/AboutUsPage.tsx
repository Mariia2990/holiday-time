            ...
            <div className={css.aboutUsBoxText}>
              <h3 className={css.aboutUsText}>
                ...
                <p className={css.aboutUsSpanBox1}>
                  ...
                  Україну з іншої сторони. Пройти разом з <br /> Вами лісовими
                  стежками, щоб попоїсти свіжого карпатського сиру. Пірнути у
                  каньйон та побачити занурене <br />
                  під товщу років село Бакота. Покататись на гандолах в
                  “українській Венеції”.
                  <br />
                  <br />
                </p>
